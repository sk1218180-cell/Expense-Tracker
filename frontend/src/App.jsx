...
const API_URL = "https://expense-tracker-backend-b6yy.onrender.com";
...
const ProtectedRoute = ({ user, children }) => {
  ...
  const hashToken = localToken || sessionToken;
...
// To scroll to top when page gets reload ar new page is visited
const ScrollToTop = () => {
