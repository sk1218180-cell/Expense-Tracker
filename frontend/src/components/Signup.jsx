...
const Signup = ({ API_URL = "https://expense-tracker-backend-b6yy.onrender.com", onSignup }) => {
      ...
      <div className={signupStyles.cardContainer}>
        <div className={signupStyles.header}>
          ...
          <p className={signupStyles.headerSubtitle}>
            Join ExpenseTracker to manage your finances and Expenses
          </p>
        </div>
