        ...
        <div className={sidebarStyles.sidebarInner.base}>
          ...
          >
            <Link
              ...
              to="https://www.hexagondigitalservices.com/contact" // for contact we can change the link
            >
            ...
            >
              <div className=" relative h-full flex flex-col">
                ...
                <div className={sidebarStyles.mobileFooter}>
                  <Link
                    onClick={() => setMobileOpen(false)}
                    to="https://www.hexagondigitalservices.com/contact" // To get the support by adding link in mobile
